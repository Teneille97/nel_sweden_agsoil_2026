...
We converted modeled age distributions into real amounts of carbon and nitrogen at each age at steady-state (taken as the final year) by scaling them with pool sizes from the best model. Then we used MCMC runs to add uncertainty ranges. The summary table shows the amount of carbon and nitrogen stocks 
